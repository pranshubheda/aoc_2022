...
class Solution {
    ...
    public static void main(String[] args) throws InterruptedException, IOException{
        ...
        char[][] grid = new char[max_y+5][max_x-min_x+20];
            ...
            for (int i = 0; i < line.length-1; i++) {
                ...
                if (coords_1[0].equals(coords_2[0])) {
                    ...
                    for (int j = 0; j < count; j++) {
                        grid[starting_x+j][coords_1[0]-min_x+10] = '#';
                        // Thread.sleep(500);
                    ...
                    for (int j = 0; j < count; j++) {
                        grid[coords_1[1]][starting_y-min_x+j+10] = '#';
                        // Thread.sleep(500);
                        // System.out.print("\033[H\033[2J");  
                        // System.out.flush();
                        // print_grid(grid);
