...
public class Solution2 {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while(sc.hasNextLine()) {
            ...
            String compartment1 = sc.nextLine();
            String compartment2 = sc.nextLine();
            String compartment3 = sc.nextLine();
            ...
            HashSet<String> set3 = new HashSet<String>(Arrays.asList(compartment3.split("")));
